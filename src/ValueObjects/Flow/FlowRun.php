...
readonly class FlowRun
{
     ...
     */
    public function withFormat(\InFlow\ValueObjects\File\DetectedFormat $format, int $totalRows): self
    {
        return new self(
            status: $this->status,
            totalRows: $totalRows,
     ...
     * @return FlowRun Updated flow run
     */
    public function withSchema(\InFlow\ValueObjects\Data\SourceSchema $schema): self
    {
        return new self(
            status: $this->status,
            totalRows: $this->totalRows,
